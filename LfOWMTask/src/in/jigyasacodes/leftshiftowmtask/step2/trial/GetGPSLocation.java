...
public class GetGPSLocation implements LocationListener {
	...
	public GetGPSLocation(OnGPSLatLngCompleteListener this1,
	...
	public void setupGPSVars(Context ctx, Context baseCtx) {
		...
		if (getGPSStatus()) {
			...
			locationListener = new GetGPSLocation(onGPSLatLngCompleteListener,
			...
			showAlertDialog("GPS Status", "GPS is disabled on your device !!");
		}

	}

	protected void showAlertDialog(String strTitle, String strMessage) {
				...
				.setNegativeButton("Leave",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int id) {
								...
								dialog.cancel();
								GPSLocationWeatherAct.setPBVisibility(View.GONE);
